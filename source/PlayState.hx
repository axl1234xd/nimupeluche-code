...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
				...
				case 'ecena':
					{
							defaultCamZoom = 0.80;
							curStage = 'ecena';
							var bg:FlxSprite = new FlxSprite(-100, -200).loadGraphic(Paths.image('hola'));
							bg.antialiasing = true;
							bg.scrollFactor.set(0.9, 0.9);
							bg.scale.set(3.0, 3.0);
							bg.active = false;
							add(bg);
		...
		switch (SONG.player2)
		{
			...
			case 'pico':
			case 'nimupeluche':
            FlxTween.tween(dad, {x: -10, y: 600}, 1.5, {type : FlxTweenType.PINGPONG, ease: FlxEase.circIn, loopDelay: 0});
	...
	*/
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'sunshine')
			...
			{
			case 588: 
			FlxG.camera.fade(FlxColor.BLACK, 3.5, true);
			case 590:
